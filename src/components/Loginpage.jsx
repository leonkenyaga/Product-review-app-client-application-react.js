...
const Login = () => {
  ...
  <div className={styles.input_div}>
      <input type="text" className={styles.input} placeholder="Username" name="username" onChange={handleChange}/>
    </div>
    <div className={styles.input_div}>
      <input type="text"className={styles.input} placeholder="Password" name="password" onChange={handleChange}/>
    </div> 
